...
void paramcl::getcommandl0()
{
  ...
  cgconf.init(38, "language","host","muser","mpwd","datenbank","sqlz","musterzahl",
...
// wird aufgerufen in Dateienherricht und empfarch
