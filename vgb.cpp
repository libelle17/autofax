...
void hhcl::pvirtVorgbSpeziell()
{
	...
	for(unsigned i{0};i<sqlVp.size();) {
		...
		opvsql<<new optcl(/*pname*/soptname.str(),/*pptr*/&sqlVp[i-1],/*art*/pstri,-1,-1,/*TxBp*/&Tx,/*Txi*/T_SQL_Befehl_Nr,/*wi*/0,/*Txi2*/-1,/*rottxt*/istr,/*wert*/-1,/*woher*/1,/*Txrf*/Tx[T_SQL_Befehl]);
