...
<p style="margin-left:11%; margin-top: -2em"><b>autofax
...
<p style="margin-top: -2em">(manpage-Hilfe in deutsch
...
<p style="margin-left:11%; margin-top: -2em"><b>autofax</b>
...
<p style="margin-top: -2em"><b>autofax</b> is a command line
...
<p style="margin-top: -2em">Additionally, received faxes
...
<p style="margin-top: -2em">The usability within a network
...
<p style="margin-left:11%; margin-top: -2em">First, please
...
<p style="margin-left:11%; margin-top: -2em">Ideally, the
...
<p style="margin-top: -2em">Then a directory e.g.
...
<p style="margin-top: -2em; line-height: 50%">&quot;<b>Medical report on Frank
...
<p style="margin-top: -2em">Those are subsequently being
relayed to <b>hylafax</b> or <b>Capisuite</b> and from there
sent.</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">Simultaneously they are being
...
<p style="margin-top: -2em">At each call, autofax checks the
...
<p style="margin-top: -2em">Further on, incoming faxes via
...
<p style="margin-top: -2em">Depending on operating system,
...
<p style="margin-left:11%; margin-top: -2em">With
...
<p style="margin-top: -2em">1) The current hardware is being
checked.</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">a) with the command
&rsquo;<b>lspci | grep -i isdn</b>&rsquo; for a fritz
card.</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">b) with the command
&rsquo;<b>stty -F</b>&rsquo; for a fax modem.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">2) The fax configuration file
<b>fax.conf</b> of capisuite is read, if it exists</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">3) Further defaults from the
...
<p style="margin-top: -2em">4) Defaults are loaded from the
...
<p style="margin-top: -2em">7) Directories used by the users
...
<p style="margin-top: -2em">8) The program inserts itsself
...
<p style="margin-top: -2em">9) The program checks if all
...
<p style="margin-top: -2em">10) Working of MariaDB is being
...
<p style="margin-top: -2em">11) In case of the respective
...
<p style="margin-top: -2em">12) Otherwise, file in the
...
<p style="margin-top: -2em">If a file contains more than one
...
<p style="margin-top: -2em">14) In case of respective
command line options faxes are being deleted and the program
is finished.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">15) Otherwise the files which
...
<p style="margin-top: -2em">16) All faxes which are recorded
...
<p style="margin-top: -2em">If hylafax and capisuite are
...
<p style="margin-top: -2em">If the fax transmission is
...
<p style="margin-top: -2em">The status of the mentioned
faxes is being displayed.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">17) If additional faxes in the
...
<p style="margin-top: -2em">Such sql commands shall deliver
...
<p style="margin-top: -2em">select concat(haname,&rsquo;,
...
<p style="margin-top: -2em">If more sql commands are
specified and one of them does not give a result, the next
one will be tried.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">Optionally, the received faxes
are subjected to ocr via a call of ocrmypdf.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">19) The configuration file is
...
<p style="margin-left:11%; margin-top: -2em"><b>Hardware</b>:
...
<p style="margin-top: -2em">(for this purpose, depending on
the distribution, zypper, apt(-get), dnf or yum are
used).</p> </td></tr>
</table>


<p style="margin-left:11%; margin-top: -2em"><b>makefile:</b></p>
...
<p style="margin-top: -2em">gcc V.6, g++ V.6, groff,
...
<p style="margin-top: -2em"><b>autofax:</b></p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">boost, boost-devel, cron,
...
<p style="margin-top: -2em">in case <b>capisuite</b> shall
be used:</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">capisuite, capiutils,
...
<p style="margin-top: -2em">in case <b>hylafax</b> shall be
used:</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">hylafax+, hylafax+-client,
sendmail, tiff (in case of version 4.0.7 with a slight
modification, see Makefile)</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">in case <b>ocr</b> shall be
used:</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">ffmpeg, ffmpeg-devel,
...
<p style="margin-top: -2em">in case You want to work on the
source files with &rsquo;sh viall&rsquo;:</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">vim</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">All those installations may
include dependent programs.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">If You don&rsquo;t want one of
...
<p style="margin-left:11%; margin-top: -2em">The program has
...
<p style="margin-top: -2em">1) In debian, in the file
...
<p style="margin-top: -2em">5) Installation of
...
<p style="margin-top: -2em">6) Installation of services:</p></td></tr>
</table>
...
<p style="margin-top: -2em">7) Creation of a logfile, per
default <b>/var/log/autofax.log</b>.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">8) if necessary creation and
making accessible of the configurable <b>directories</b> for
faxes to be sent, waiting, finished and failed.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">9) if necessary creation and
...
<p style="margin-top: -2em">10) Insertion of a line for the
periodic automatic program call in root&rsquo;s crontab</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">11) if necessary insertion of
...
<p style="margin-top: -2em">12) if necessary insertion of a
...
<p style="margin-top: -2em">13) With specific command line
...
<p style="margin-top: -2em">14) With a specific command line
...
<p style="margin-left:11%; margin-top: -2em">Change in a
...
<p style="margin-top: -2em">Call <b>make uninstall</b>.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">Then the installed
...
<p style="margin-top: -2em">Thereby additionally installed
program packets, permissions, samba shares and firewall
exceptions are deleted.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">Configuration files, data, and
system relevant programs like libgcc and selinux will not be
deleted.</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">Error messages originate mostly
...
<p style="margin-left:11%; margin-top: -2em">Please report
...
<p style="margin-top: -2em">Nevertheless the author cannot
...
<p style="margin-left:11%; margin-top: -2em">Gerald Schade
...
<p style="margin-top: -2em">(manpage available in english:
...
<p style="margin-top: -2em"><b>autofax</b> ist ein
...
<p style="margin-top: -2em">Au&szlig;erdem
...
<p style="margin-top: -2em">Die Netzwerkintegration (z.B.
...
<p style="margin-left:11%; margin-top: -2em">Zun&auml;chst
...
<p style="margin-left:11%; margin-top: -2em">Im Idealfall
...
<p style="margin-top: -2em">Es existiert dann ein
...
<p style="margin-top: -2em">&quot;<b>Arztbericht zu Franz
...
<p style="margin-top: -2em">Wenn <b>autofax</b> beim
...
<p style="margin-top: -2em">Diese werden dann automatisch an
<b>hylafax</b> oder <b>Capisuite</b> weitergeleitet und von
dort aus verschickt.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">Gleichzeitig werden sie aus
...
<p style="margin-top: -2em">Bei jedem Aufruf
...
<p style="margin-top: -2em">Weiterhin werden &uuml;ber
...
<p style="margin-top: -2em">Der Benutzer k&ouml;nnte
...
<p style="margin-left:11%; margin-top: -2em">Mit
...
<p style="margin-top: -2em">1) Die aktuelle Hardware wird
&uuml;berpr&uuml;ft:</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">a) mit dem Befehl
&rsquo;<b>lspci | grep -i isdn</b>&rsquo; bez&uuml;glich
einer ISDN-Karte</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">b) mit dem Befehl &rsquo;<b>stty
-F</b>&rsquo; bez&uuml;glich eines Fax-Modems.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">2) Die Fax-Konfigurationsdatei
<b>fax.conf</b> der Capisuite wird eingelesen, falls es sie
gibt</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">3) Weitere Vorgaben aus dem
...
<p style="margin-top: -2em">4) Vorgaben werden geladen aus
...
<p style="margin-top: -2em">5) R&uuml;ckfragen werden
...
<p style="margin-top: -2em">6) Das Verzeichnis von
...
<p style="margin-top: -2em">7) Von Benutzern verwendete
...
<p style="margin-top: -2em">8) Das Programm tr&auml;gt
...
<p style="margin-top: -2em">9) Das Programm
...
<p style="margin-top: -2em">10) Der Betrieb von MariaDB wird
...
<p style="margin-top: -2em">11) Im Fall der entsprechenden
...
<p style="margin-top: -2em">12) Andernfalls werden Dateien
...
<p style="margin-top: -2em">Falls eine Datei mehrere
...
<p style="margin-top: -2em">14) Im Fall entsprechender
Kommandozeilenoptionen werden Faxe gel&ouml;scht und das
Programm dann beendet.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">15) Andernfalls werden die unter
...
<p style="margin-top: -2em">16) Alle in <b>spooltab</b> als
...
<p style="margin-top: -2em">Falls sowohl hylafax als auch
...
<p style="margin-top: -2em">Falls der Faxvorgang
...
<p style="margin-top: -2em">Der Status der genannten Faxe
wird angezeigt.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">17) Weitere in der Warteschleife
...
<p style="margin-top: -2em">18) &Uuml;ber
...
<p style="margin-top: -2em">Solche SQL-Befehle sollen
...
<p style="margin-top: -2em">Wenn mehrere SQL-Befehle
angegeben werden, so wird der jeweils naechste angewandt,
wenn einer kein Ergebnis liefert.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">Optional werden die empfangenen
Dateien mit Hilfe von ocrmypdf einer Texterkennung
unterzogen.</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">19) Die Konfigurationsdatei
...
<p style="margin-top: -2em">(hierzu wird je nach
Distribution zypper, apt(-get), dnf oder yum verwendet).</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em"><b>makefile:</b></p></td></tr>
<tr valign="top" align="left">
...
<p style="margin-top: -2em">falls <b>capisuite</b> benutzt
werden soll:</p></td></tr>
<tr valign="top" align="left">
...
<p style="margin-top: -2em">falls <b>hylafax</b> benutzt
werden soll:</p></td></tr>
<tr valign="top" align="left">
...
<p style="margin-top: -2em">falls <b>ocr</b> benutzt werden
soll:</p> </td></tr>
<tr valign="top" align="left">
...
<p style="margin-top: -2em">falls Sie die Quelldateien mit
...
<p style="margin-top: -2em">All diese Installationen
k&ouml;nnen abh&auml;ngige Programme
einschlie&szlig;en.</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">Falls Sie eines dieser Programme
...
<p style="margin-left:11%; margin-top: -2em">Das Programm
...
<p style="margin-top: -2em">1) In Debian kann in der Datei
...
<p style="margin-top: -2em">4) Installieren von
...
<p style="margin-top: -2em">5) Installieren von
...
<p style="margin-top: -2em">6) Einrichten von Diensten:</p></td></tr>
</table>
...
<p style="margin-top: -2em">7) Erstellen einer
Protokolldatei, standardm&auml;&szlig;ig
<b>/var/log/autofax.log</b>.</p> </td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">8) ggf. Erstellen und
...
<p style="margin-top: -2em">9) ggf. Erstellen und
...
<p style="margin-top: -2em">10) ggf. Einf&uuml;gen einer
Zeile zum automatischen periodischen Aufruf des Programms in
das crontab (von root)</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">11) ggf. Einf&uuml;gen von
...
<p style="margin-top: -2em">12) ggf. Einf&uuml;gen einer
...
<p style="margin-top: -2em">13) durch entsprechende
...
<p style="margin-top: -2em">14) mit einer
...
<p style="margin-left:11%; margin-top: -2em">Wechseln Sie in
...
<p style="margin-top: -2em">Rufen Sie dort <b>make
uninstall</b> auf.</p></td></tr>
<tr valign="top" align="left">


<p style="margin-top: -2em">Dadurch wird das installierte
...
<p style="margin-top: -2em">Dadurch werden
...
<p style="margin-top: -2em">Auf die Deinstallation der
...
<p style="margin-top: -2em">Etwaige Fehlermeldungen beziehen
...
<p style="margin-left:11%; margin-top: -2em">Fehler bitte
...
<p style="margin-top: -2em">Trotzdem kann der Autor
