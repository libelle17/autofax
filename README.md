...
<h1 align="center">AUTOFAX (Version 0.40389)</h1>
...
in $(ls -d ${P}_* | cut -d&rsquo;_&rsquo; -f2 | sort -nr);
do j=$((i+1)); case $i in &rsquo;&rsquo;|*[!0-9]*);; *) mv
${P}_$i ${P}_$j; esac; done; test -d $P && mv $P
${P}_1; } && mv $P-master $P && cd $P <br>
