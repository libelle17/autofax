...
<h1 align="center">AUTOFAX (Version 0.42764) - english<a name="english_E"></a></h1>
...
...</b> <br>
With &rsquo;<b>autofax -?</b>&rsquo;, all command line
options can be seen. Some options (e.g. the sql commands)
cannot bei set via the command line, but only via the
configuration file, which can be edited directly or
interactively by &rsquo;<b>autofax -rf</b>&rsquo;. <b><br>
Options which are not saved: <br>
-v, --verbose</b>: screen output more verbose <b><br>
-l, --log</b>: put detailed logs in file
&rsquo;<b>/var/log/gsautofax.log</b>&rsquo; (otherwise
shorter) <b><br>
...
be used instead of &rsquo;<b>gsautofax.log</b>&rsquo;
<b><br>
-tdr, --tofaxdir &lt;path&gt;</b>: faxes the files from
&lt;path&gt; instead of
&rsquo;<b>/vista/P/zufaxen</b>&rsquo; <b><br>
...
faxes &rsquo;<b>/vista/P</b>&rsquo; <b><br>
...
-capi, --takecapi</b>: use capisuite[0;35m or not <b><br>
-hyla, --takehyla</b>: use hylafax[0;35m or not <b><br>
-fc, --firstcapi</b>: try to send faxes primarily via
capisuite[0;35m or not <b><br>
-fh, --firsthyla</b>: try to send faxes primarily via
hylafax[0;35m or not <b><br>
-mod, --hmodem &lt;string&gt;</b>: Modem used for hylafax,
instead of &rsquo;<b>ttyS1</b>&rsquo; <b><br>
...
directory irrespective of faxing success[0;35m or not
<b><br>
-ocri, --ocri</b>: Text from received faxes will be
filtered[0;35m or not <b><br>
-ocro, --ocro</b>: Text from sent pictures will be
filtered[0;35m or not <b><br>
...
<h1 align="center">AUTOFAX (Version 0.42764) - deutsch<a name="deutsch_D"></a></h1>
